		...
		if(response.status) {
			for(var i=0;i<response.data.length;i++) {
				...
				if(!response.data[i].retweeted) {
					html_response += '<div class="row"><div class="col-lg-1"></div><div class="col-lg-11"><img id="' + response.data[i].id + '"onClick="retweet_id(\'' + response.data[i].id + '\');" src="static/images/twitter_retweet.jpg" style="margin-top: 20px; width: 30px;"></div>';
				}
				else {
					html_response += '<div class="row"><div class="col-lg-1"></div><div class="col-lg-11"><img id="' + response.data[i].id + '"onClick="destroy_tweet(\'' + response.data[i].id + '\');" src="static/images/twitter_cancel_retweet.jpg" style="margin-top: 20px; width: 30px;"></div>';
				}
